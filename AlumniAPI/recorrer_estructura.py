...
NOMBRE_ARCHIVO_SALIDA = "estructura_src_AlumniAPI"
...
ESTE ARCHIVO ES SOBRE EL CONTENIDO Y ESTRUCTURA DEL BACKEND REALIZADO EN DJANGO AlumniAPI
ESTE CONTIENE TODA LA LOGICA DE LA API PARA LA AUTENTICACION DEL PORTAL WEB ALUMNI
