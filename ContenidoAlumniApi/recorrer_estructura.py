...
NOMBRE_ARCHIVO_SALIDA = "estructura_src_ContenidoAlumniApi"
...
ESTE ARCHIVO ES SOBRE EL CONTENIDO Y ESTRUCTURA DEl BACKEND REALIZADO EN DJANGO ContenidoAlumniApi
ESTE CONTIENE TODA LA LOGICA DE LA API PARA EL CONTENIDO DEL PORTAL WEB ALUMNI 
